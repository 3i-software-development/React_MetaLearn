...
namespace QuickApp.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        {
            throw new InvalidOperationException("This is a testepyhmneoph exception: " + DateTime.Now);
        }
        ...
        public async Task<string> Email()
        {
            ...
            string recepientEmail = "testepyhmneoph@ebenmonney.com"; //   <===== Put the recepient's email here
